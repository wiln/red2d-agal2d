package particle_ex
{
	 ...
	 */
	public class Test04_DemoView2 extends Red_Scene
	{
		[Embed( source = "../resource/particle/snow.png" )]
		private var MapTest:Class;
		
		[Embed( source = "../resource/particle/bg02.jpg" )]
		...
		public function Test04_DemoView2()
		{
			super();
		}		
		...
		public override function setDesign():void{	
			...
			obj.maxParticleNum='150.14'
			obj.particle_moveSpeed='1'
			obj.emitterAreaWidth='1280'
