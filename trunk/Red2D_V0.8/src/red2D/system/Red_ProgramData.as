package red2D.system
{
	...
	import red2D.system.shaderType.Filter;
	...
	public class Red_ProgramData
	{
		...
		public function setShaderProgram3D( $shaderType:String):void
		{
			...
			switch ($shaderType){
				...
				case "filter" :
					// 프레그먼트필터효과를 지정
					_filter.filters = _targetFilters
					_shaderProgram = _filter.getShaderProgram()
					_currentShaderType = $shaderType
					break
			}
		}	
