package game
{
	...
	public class Test_Game extends Red_Scene
	{
		...
		private function setResource():void
		{
			...
			stage.addEventListener(Event.ENTER_FRAME,  HD_PointerMove)
		}
		
		protected function HD_PointerMove(event:Event):void
		{
		...
		protected function gameStateUpdate(event:Event):void
		{
			...
			if(_keyState.space && _prevSpaceState==false){	
				var bulletItem:Missile = new Missile(16,16,_player.x, _player.y)
