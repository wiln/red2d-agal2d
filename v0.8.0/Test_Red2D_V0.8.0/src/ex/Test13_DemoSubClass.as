package ex  
{
	...
	public class Test13_DemoSubClass extends Red_Sprite
	{
		...
		{
			var material1:BitmapMaterial = new BitmapMaterial(new Photo01().bitmapData)
			var material2:BitmapMaterial = new BitmapMaterial(new Photo02().bitmapData)
			var material3:BitmapMaterial = new BitmapMaterial(new Photo03().bitmapData)
			var material4:BitmapMaterial = new BitmapMaterial(new Photo04().bitmapData)
			var material5:BitmapMaterial = new BitmapMaterial(new Photo05().bitmapData)
			var material6:BitmapMaterial = new BitmapMaterial(new Photo06().bitmapData)
			var material7:BitmapMaterial = new BitmapMaterial(new Photo07().bitmapData)
			var material8:BitmapMaterial = new BitmapMaterial(new Photo08().bitmapData)
